...
<body>
    ...
    <main>
            ...
            <div class="slider-container">
                <div class="slider">
                    <div class="slide">
                        ...
                        <a href="https://www.kompas.com/food/read/2021/10/27/133600175/sampah-makanan-di-indonesia-jadi-permasalahan-serius-" class="visit-btn">Kunjungi Kami</a>
                    </div>
                    <div class="slide">
                        <img src="img/Berita 2.jpg" alt="Food Waste News 2">
                        <a href="https://money.kompas.com/read/2021/10/12/134814026/hampir-50-persen-sampah-di-jawa-barat-dan-jawa-tengah-berasal-dari-makanan" class="visit-btn">Kunjungi Kami</a>
                    </div>
                    <div class="slide">
                        <img src="img/BErita3..jpg" alt="Food Waste News 3">
                        <a href="https://www.cnbcindonesia.com/news/20230621133615-4-447957/jatah-makanan-61-juta-orang-dibuang-buang-di-ri" class="visit-btn">Kunjungi Kami</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="about">
            <h2>Tentang Kami</h2>
            <p>Food Waste Reduction Marketplace adalah platform yang kami buat untuk mengurangi pemborosan makanan
                dengan menghubungkan restoran yang memiliki makanan berlebih dengan konsumen yang mencari makanan
                berkualitas dengan harga terjangkau. Kami berkomitmen untuk menciptakan solusi berkelanjutan dalam
                industri makanan dan membantu mengurangi dampak lingkungan dari pemborosan makanan.</p>
        </section>
        ...
        const restaurants = [
            {
                ...
                foodWaste: [
                    ...
                    { id: 2, name: "Kentang Goreng", price: 10000 },
                    { id: 3, name: "Nasi Putih", price: 5000 }
                ]
            },
            {
                id: 2,
                ...
                foodWaste: [
                    { id: 4, name: "Sisa Mie Level 2", price: 12000 },
                    { id: 5, name: "Pangsit Goreng", price: 8000 },
                    { id: 6, name: "Ceker Pedas", price: 10000 }
                ]
            },
            {
                id: 3,
                name: "Roti Boy",
                description: "Roti dan kue segar",
            ...
            },
            {
                ...
                image: "img/MCD.jpg",
                foodWaste: [
                    { id: 10, name: "Sisa Burger Sapi", price: 20000 },
