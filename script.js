...
<body>
    ...
    <main>
                ...
                <div class="slider">
                    <div class="slide">
                        ...
                        <div class="slide-content">
                            <h3>Food Waste in Indonesia Becomes a Serious Problem</h3>
                    ...
                    <div class="slide">
                        ...
                        <div class="slide-content">
                            <h3>Nearly 50 Percent of Waste in West Java and Central Java Comes from Food</h3>
                    ...
                    <div class="slide">
                        ...
                        <div class="slide-content">
                            <h3>Food Rations of 6.1 Million People Wasted in Indonesia</h3>
        ...
        <section id="about">
            ...
            <div class="about-content">
                <div class="about-text">
                    <p>Save Bite is a platform we created to reduce food waste by connecting restaurants with excess food with consumers looking for quality food at affordable prices.</p>
                    <p>We are committed to creating sustainable solutions in the food industry and helping to reduce the environmental impact of food waste.</p>
                </div>
        ...
        <section id="contact" style="text-align: center">
            <h2 style="color: #107873;">Contact us</h2>
            <p>If there are any problems or if you want to collaborate, please contact us at: <a
    ...
    <footer>
        <p>&copy; 2024 Food Waste Reduction Marketplace. All Rights Reserved.</p>
    </footer>
    ...
    <script>
        ...
        const restaurants = [
            {
                ...
                foodWaste: [
                    { id: 1, name: "leftover fried chicken", price: 15000 },
                    { id: 2, name: "Leftover French Fries", price: 10000 },
                    { id: 3, name: "Leftover Rice", price: 5000 }
                ]
            },
            {
                id: 2,
                name: "Gacoan",
                description: "Spicy noodles and snacks",
                image: "img/GACOAN (2).png",
                foodWaste: [
                    { id: 4, name: "letfover noodle", price: 12000 },
                    { id: 5, name: "Leftover Fried Dumplings", price: 8000 },
                    { id: 6, name: "Dimsum Leftovers", price: 10000 }
                ]
            },
            {
                id: 3,
                name: "Roti Boy",
                description: "Favorite Bakery",
                image: "img/Roti BOY.jpg",
                foodWaste: [
                    { id: 7, name: "Chocolate Bread", price: 7000 },
                    { id: 8, name: "Chocolate Cheese", price: 7000 },
                    { id: 9, name: "Donut", price: 5000 }
                ]
            },
            {
                id: 4,
        ...
        function createRestaurantCards() {
            ...
            restaurants.forEach(restaurant => {
                ...
                card.innerHTML = `
                    ...
                    <button onclick="openOrderModal(${restaurant.id})">View Menu & Order</button>
                `;
        ...
        document.getElementById("orderForm").onsubmit = function (e) {
            ...
            receiptContent += `
                ...
                <p><strong>Shipping cost:</strong> Rp 10.000</p>
                <p><strong>Payment Methods:</strong> ${paymentMethod}</p>
